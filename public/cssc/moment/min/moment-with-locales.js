...
// Returns a moment from input, that is local/utc/zone equivalent to model.
...
/**
 * Returns a human readable representation of a moment that can
...
hooks.defineLocale('fr', {
    ...
    ordinal : function (number, period) {
        switch (period) {
            // TODO: Returns 'e' when day of month > 1. Move this case inside
