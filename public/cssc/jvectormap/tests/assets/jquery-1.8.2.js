...
jQuery.support = (function() {
	...
	jQuery(function() {
		...
		if ( !body ) {
			// Returns for frameset docs that don't have a body
			return;
		}
...
if ( !jQuery.support.style ) {
	jQuery.attrHooks.style = {
		get: function( elem ) {
			// Returns undefined in the case of empty string
		...
		if ( fragment ) {
			...
			handleScript = function( elem ) {
				...
				if ( !elem.type || rscriptType.test( elem.type ) ) {
					...
					// Returns truthy to indicate that it has been handled
					return scripts ?
...
jQuery.extend({
	...
	css: function( elem, name, numeric, extra ) {
		...
		// Returns, converting to number if forced or a qualifier was provided and val looks numeric
