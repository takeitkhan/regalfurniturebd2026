...
namespace App\Repositories\RelatedProducts;


use App\Models\RelatedProducts;

class EloquentRelatedProducts implements RelatedProductsInterface
{
    private $model;
     ...
     */
    public function __construct(RelatedProducts $model)
    {
        $this->model = $model;
    }
