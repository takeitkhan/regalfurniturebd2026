...
@php use App\Models\Oneclickbuy; @endphp
...
@section('content')
    ...
    <div class="row">
        ...
        @endif
        @php
            $dc = PaymentSetting::where('id', 1)->first();
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        ...
                        <a href="javascript:void(0)" class="btn btn-xs btn-success pull-right"
                           id="go-to-add-product-button"><i class="fa fa-align-justify"></i></a>
                    </div>
                    <div class="box-body" style="">
                        <div class="box-body table-responsive no-padding">

                            <div class="order-input-number text-center justify-content-center"
                            ...
                            <div class="add-new-product" xstyle="display:none;">
                                ...
                                <div class="row productSelectArea">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control order-input-search" style=""
                                                id="order-input-search">
                                        </select>
                                    </div>
                                ...
                                @if($getOneClickProduct)
                                    ...
                                    @foreach($getOneClickProduct as $product)
                                        @php
                                            ...
                                            $productImage = ProductImages::where('main_pid', $productID)->first()->icon_size_directory;
                                            $qty = 1;
                                            //dd($product);
                                        @endphp
                                        <tr data-row_id="{{$productID}}" id="productRow">
                                            <td>
                                                <input type="hidden" name="product[${productID}][product_id]"
                                                       value="{{$productID}}">
                                                <input type="hidden" name="product[${productID}][product_name]"
                                                       value="{{$productName}}">
                                                <input type="hidden" name="product[${productID}][product_code]"
                                                       value="{{$productCode}}">
                                            ...
                                            <td>
                                                <input class="change-qty" type="number"
                                                       name="product[${productID}][qty]" maxlength="2" min="1"
                                                       value="{{$qty}}" max="99" style="width: 4em">
                                            </td>
                                            <td></td>
                                            <td></td>
                                            <td>৳ <input name="product[${productID}][price]" type="number"
                                                         value="{{$productPrice}}" class="change-price"
                                                         data-productcode="" maxlength="2" min="1" style="width:4em">
                                            </td>
                                            <td><strong>৳<span
                                                            class="this_product_total_price">{{$qty * $productPrice}}</span></strong>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-xs btn-danger remove_row"
                    ...
                    <div class="box-footer clearfix text-center">
                        ...
                        <div class="pull-right" style="display:inline; text-align: end">
                            <div style="padding: 3px;">
                                ...
                                <input readonly type="number" name="total_price" id="the_total_price"
                                       style="width:7em;display:inline;">
                            </div>
                            <div style="padding: 3px;">
                                <div style="display:inline;">Discount</div>
                                <input readonly type="number" name="total_discount" id="the_total_discount"
                                       style="width:7em;display:inline;" min="0">
                            </div>
                            <div style="padding: 3px;">
                                <div style="display:inline;">Delivery Charge</div>
                                <input type="number" value="0" min="0" name="delivery_price" id="the-delivery-charge"
                                       style="width:7em;display:inline;">
                            </div>
                            <div style="padding: 3px;">
                                <div style="display:inline;">Grand Total</div>
                                <input readonly type="number" name="grand_total" id="the-grand-total"
                                       style="width:7em;display:inline;">
                            </div>
                            <button type="button" zid="submitButton" onclick="submitProductCart()"
