                                            ...
                                            <fieldset id="account">
                                                ...
                                                <div class="form-group has-feedback required">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        {{ Form::text('phone', $phone, ['required', 'class' => 'form-control', 'for' => 'input-payment-telephone', 'placeholder' => 'Mobile Number']) }}
                                                    </div>
                                                ...
                                                <div class="form-group has-feedback required">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">+88 </span>
                                                        {{ Form::text('emergency_phone', $e_phone, ['required', 'class' => 'form-control', 'for' => 'input-payment-telephone', 'placeholder' => 'Emergency Mobile Number']) }}
                                                    </div>
                                                </div>
                                                <div class="form-group required">
