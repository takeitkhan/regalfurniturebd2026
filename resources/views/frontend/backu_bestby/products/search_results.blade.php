...
@section('content')
    ...
    <div class="main-container container">
        @php
            $term = App\Term::where('id', $category_info->parent)->where('id', '!=', 1)->get()->first();
            if ($term) {
                $subterm = App\Term::where('id', $term->parent)->where('id', '!=', 1)->get()->first();
            }else {
                $subterm = null;
            }
        @endphp
        <ul class="breadcrumb">
            ...
            @if ($subterm)
            <li><a href="{{ url('c/' . $subterm->seo_url) }}">{{ $subterm->name }}</a></li>
            @endif
            @if ($term)
            <li><a href="{{ url('c/' . $term->seo_url) }}">{{ $term->name }}</a></li>
            @endif
                            ...
                            <h3 class="modtitle-single">
                                ...
                                <footer class="bottom_box" style="margin-top: 15px">
                                    <div class="buttons_row">
                                        <a class="button_grey button_submit" href="javascript: void(0)"
                                           style="padding:3px 8px"
                                           id="keyword_filter_submit">Search</a>
                                        <a class="button_grey filter_reset" href="javascript: void(0)"
                                           style="padding:3px 8px"
                                           id="keyword_filter_reset">Reset</a>
                                        <a class="button_grey filter_reset" href="{{url($cat_url)}}"
                                           style="padding:3px 8px"
                                        >Clear All</a>
                                    </div>
                                    <!--Back To Top-->
                                ...
                                <span class="modtitle-tit">CATEGORIES</span>
